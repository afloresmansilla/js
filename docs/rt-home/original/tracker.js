...
function IsGtmTokenEnable() {
    for (var t = ["coches-ocasion.rastreator", "accesoriosparamoviles.rastreator", "viajes.rastreator", "adopta-un-perro.rastreator", "tarifas-adsl-fibra.rastreator"], n = 0; n < t.length; n++)
        if (document.URL.toLowerCase().indexOf(t[n]) > -1) return !0;
    return !1
}
...
function GetGTMUrl() {
    ...
    return document.URL.indexOf("rastreator.com") >= 0 ? (gtmId = "GTM-NRC6WMJ", gtmAuth = "mxRNCcgZUIAFul50k1K_pg", gtmPreview = "env-2", trackerUrlProduction + "/Tracker/GetGtmScriptV2") : document.URL.indexOf("altas-internet.com") >= 0 ? (gtmId = "GTM-F5H2", trackerUrlAltas + "/Tracker/GetGtmScriptV2") : document.URL.indexOf("altas-seguros.com") >= 0 ? (gtmId = "GTM-F5H2", trackerUrlProduction + "/Tracker/GetGtmScriptV2") : void 0
}
...
function SaveTracker(n, t) {
    ...
    i = "";
    document.visibilityState == "prerender" ? (i = GetTrackerUrl() + "/Tracker/SavePrerenderDetail", CommonJsonPRequest.send(i + "?callback=SaveTrackerCallback&browserState=" + document.visibilityState, {
        callbackName: "SaveTrackerCallback",
        onSuccess: function() {},
        onTimeout: function() {},
        timeout: 30
    })) : (typeof n == "string" ? (r = n, u = !0) : (r = JSON.stringify(n), u = !1), e = {
        counterName: r,
        refererUrl: f,
        type: u,
        productID: t
...
var trackerUrlLocal = "http://localhost:55991",
    ...
    initializer = {
        ...
        onloadScripts: function() {
            document.body != null && (clearInterval(initializer.timerHandle), RenderGTMScript())
        }
    },
    CommonJsonPRequest = function() {
        var n = {};
        return n.send = function(n, t) {
            var r = t.callbackName || "callback",
                u = t.onSuccess || function() {},
