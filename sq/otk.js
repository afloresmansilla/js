!function(e, t, n) {
    ...
    var e = function(e, t) {
      ...
      , o = function(o, l) {
        l = l || 0;
        for (var s = (o = o || "").length % 16, c = o.length - s, u = [0, l], d = [0, l], g = [0, 0], f = [0, 0], h = [2277735313, 289559509], m = [1291169091, 658871167], p = 0; p < c; p += 16)
            g = [255 & o.charCodeAt(p + 4) | (255 & o.charCodeAt(p + 5)) << 8 | (255 & o.charCodeAt(p + 6)) << 16 | (255 & o.charCodeAt(p + 7)) << 24, 255 & o.charCodeAt(p) | (255 & o.charCodeAt(p + 1)) << 8 | (255 & o.charCodeAt(p + 2)) << 16 | (255 & o.charCodeAt(p + 3)) << 24],
            f = [255 & o.charCodeAt(p + 12) | (255 & o.charCodeAt(p + 13)) << 8 | (255 & o.charCodeAt(p + 14)) << 16 | (255 & o.charCodeAt(p + 15)) << 24, 255 & o.charCodeAt(p + 8) | (255 & o.charCodeAt(p + 9)) << 8 | (255 & o.charCodeAt(p + 10)) << 16 | (255 & o.charCodeAt(p + 11)) << 24],
            g = t(g, h),
            g = n(g, 31),
            g = t(g, m),
            u = r(u, g),
        ...
        s) {
        case 15:
            f = r(f, a([0, o.charCodeAt(p + 14)], 48));
        case 14:
            f = r(f, a([0, o.charCodeAt(p + 13)], 40));
        case 13:
            f = r(f, a([0, o.charCodeAt(p + 12)], 32));
        case 12:
            f = r(f, a([0, o.charCodeAt(p + 11)], 24));
        case 11:
            f = r(f, a([0, o.charCodeAt(p + 10)], 16));
        case 10:
            f = r(f, a([0, o.charCodeAt(p + 9)], 8));
        case 9:
            f = r(f, [0, o.charCodeAt(p + 8)]),
            f = t(f, m),
            f = n(f, 33),
            f = t(f, h),
            d = r(d, f);
        case 8:
            g = r(g, a([0, o.charCodeAt(p + 7)], 56));
        case 7:
            g = r(g, a([0, o.charCodeAt(p + 6)], 48));
        case 6:
            g = r(g, a([0, o.charCodeAt(p + 5)], 40));
        case 5:
            g = r(g, a([0, o.charCodeAt(p + 4)], 32));
        case 4:
            g = r(g, a([0, o.charCodeAt(p + 3)], 24));
        case 3:
            g = r(g, a([0, o.charCodeAt(p + 2)], 16));
        case 2:
            g = r(g, a([0, o.charCodeAt(p + 1)], 8));
        case 1:
            g = r(g, [0, o.charCodeAt(p)]),
            g = t(g, h),
            g = n(g, 31),
            g = t(g, m),
            u = r(u, g)
        }
        return u = r(u, [0, o.length]),
        d = r(d, [0, o.length]),
        u = e(u, d),
        d = e(d, u),
        u = i(u),
      ...
      , h = function(e) {
        ...
        return navigator.plugins && (t = t.concat(f(e))),
        t
    }
      , m = function(e) {
      ...
      , E = function() {
        ...
        e.shaderSource(l, "precision mediump float;varying vec2 varyinTexCoordinate;void main() {gl_FragColor=vec4(varyinTexCoordinate,0,1);}"),
        e.compileShader(l),
        e.attachShader(i, o),
        e.attachShader(i, l),
        e.linkProgram(i),
      ...
      , P = function() {
        ...
        return a.indexOf("win") >= 0 && "Windows" !== e && "Windows Phone" !== e || ((a.indexOf("linux") >= 0 || a.indexOf("android") >= 0 || a.indexOf("pike") >= 0) && "Linux" !== e && "Android" !== e || ((a.indexOf("mac") >= 0 || a.indexOf("ipad") >= 0 || a.indexOf("ipod") >= 0 || a.indexOf("iphone") >= 0) && "Mac" !== e && "iOS" !== e || ((a.indexOf("win") < 0 && a.indexOf("linux") < 0 && a.indexOf("mac") < 0 && a.indexOf("iphone") < 0 && a.indexOf("ipad") < 0) !== ("Other" === e) || void 0 === navigator.plugins && "Windows" !== e && "Windows Phone" !== e)))
    }
      , L = function() {
      ...
      , G = [{
        ...
        key: "plugins",
        getData: function(e, t) {
            R() ? t.plugins.excludeIE ? e(t.EXCLUDED) : e(h(t)) : e(f(t))
        }
    }, {
        key: "canvas",
        getData: function(e, t) {
        ...
        getData: function(e, t) {
            ...
            var r = document.getElementsByTagName("body")[0]
              ...
              , d = function(e) {
                for (var t = !1, a = 0; a < n.length; a++)
                    if (t = e[a].offsetWidth !== l[n[a]] || e[a].offsetHeight !== s[n[a]])
                        return t;
                return t
            }
              , g = function() {
            ...
            for (var f = 0, h = n.length; f < h; f++)
                l[n[f]] = g[f].offsetWidth,
                s[n[f]] = g[f].offsetHeight;
            var m = function() {
            ...
            r.appendChild(o);
            for (var p = [], T = 0, v = a.length; T < v; T++)
                d(m[a[T]]) && p.push(a[T]);
            r.removeChild(o),
            r.removeChild(i),
            e(p)
        ...
        key: "fontsFlash",
        getData: function(e, t) {
            return D() ? _() ? t.fonts.swfPath ? void N(function(t) {
                e(t)
...
!function(t, e) {
        ...
        var a = o.MD5 = n.extend({
            ...
            _doProcessBlock: function(t, e) {
                ...
                var o = this._hash.words
                  ...
                  , D = o[3];
                z = c(z, A, C, D, a, 7, s[0]),
                D = c(D, z, A, C, l, 12, s[1]),
                C = c(C, D, z, A, d, 17, s[2]),
                A = c(A, C, D, z, p, 22, s[3]),
                z = c(z, A, C, D, _, 7, s[4]),
                D = c(D, z, A, C, v, 12, s[5]),
                C = c(C, D, z, A, y, 17, s[6]),
                A = c(A, C, D, z, g, 22, s[7]),
                z = c(z, A, C, D, B, 7, s[8]),
                D = c(D, z, A, C, w, 12, s[9]),
                C = c(C, D, z, A, k, 17, s[10]),
                A = c(A, C, D, z, S, 22, s[11]),
                z = c(z, A, C, D, m, 7, s[12]),
                D = c(D, z, A, C, x, 12, s[13]),
                C = c(C, D, z, A, b, 17, s[14]),
                z = h(z, A = c(A, C, D, z, H, 22, s[15]), C, D, l, 5, s[16]),
                D = h(D, z, A, C, y, 9, s[17]),
                C = h(C, D, z, A, S, 14, s[18]),
                A = h(A, C, D, z, a, 20, s[19]),
                z = h(z, A, C, D, v, 5, s[20]),
                D = h(D, z, A, C, k, 9, s[21]),
                C = h(C, D, z, A, H, 14, s[22]),
                A = h(A, C, D, z, _, 20, s[23]),
                z = h(z, A, C, D, w, 5, s[24]),
                D = h(D, z, A, C, b, 9, s[25]),
                C = h(C, D, z, A, p, 14, s[26]),
                A = h(A, C, D, z, B, 20, s[27]),
                z = h(z, A, C, D, x, 5, s[28]),
                D = h(D, z, A, C, d, 9, s[29]),
                C = h(C, D, z, A, g, 14, s[30]),
                z = f(z, A = h(A, C, D, z, m, 20, s[31]), C, D, v, 4, s[32]),
                D = f(D, z, A, C, B, 11, s[33]),
                C = f(C, D, z, A, S, 16, s[34]),
                A = f(A, C, D, z, b, 23, s[35]),
                z = f(z, A, C, D, l, 4, s[36]),
                D = f(D, z, A, C, _, 11, s[37]),
                C = f(C, D, z, A, g, 16, s[38]),
                A = f(A, C, D, z, k, 23, s[39]),
                z = f(z, A, C, D, x, 4, s[40]),
                D = f(D, z, A, C, a, 11, s[41]),
                C = f(C, D, z, A, p, 16, s[42]),
                A = f(A, C, D, z, y, 23, s[43]),
                z = f(z, A, C, D, w, 4, s[44]),
                D = f(D, z, A, C, m, 11, s[45]),
                C = f(C, D, z, A, H, 16, s[46]),
                z = u(z, A = f(A, C, D, z, d, 23, s[47]), C, D, a, 6, s[48]),
                D = u(D, z, A, C, g, 10, s[49]),
                C = u(C, D, z, A, b, 15, s[50]),
                A = u(A, C, D, z, v, 21, s[51]),
                z = u(z, A, C, D, m, 6, s[52]),
                D = u(D, z, A, C, p, 10, s[53]),
                C = u(C, D, z, A, k, 15, s[54]),
                A = u(A, C, D, z, l, 21, s[55]),
                z = u(z, A, C, D, B, 6, s[56]),
                D = u(D, z, A, C, H, 10, s[57]),
                C = u(C, D, z, A, y, 15, s[58]),
                A = u(A, C, D, z, x, 21, s[59]),
                z = u(z, A, C, D, _, 6, s[60]),
                D = u(D, z, A, C, S, 10, s[61]),
                C = u(C, D, z, A, d, 15, s[62]),
                A = u(A, C, D, z, w, 21, s[63]),
                o[0] = o[0] + z | 0,
                o[1] = o[1] + A | 0,
                o[2] = o[2] + C | 0,
                o[3] = o[3] + D | 0
    ...
    function(t) {
        ...
        e.SHA256 = n._createHelper(h),
        e.HmacSHA256 = n._createHmacHelper(h)
    }(Math),
    function() {
        var t = l
          , e = t.lib.WordArray
        ...
        var e = l
          ...
          , d = o.RIPEMD160 = n.extend({
            ...
            _doProcessBlock: function(t, e) {
                ...
                var o, l, d, w, k, S, m, x, b, H, z, A = this._hash.words, C = f.words, D = u.words, R = s.words, E = a.words, M = c.words, F = h.words;
                S = o = A[0],
                m = l = A[1],
                x = d = A[2],
                b = w = A[3],
                ...
                for (r = 0; r < 80; r += 1)
                    z = o + t[e + R[r]] | 0,
                    z += r < 16 ? p(l, d, w) + C[0] : r < 32 ? _(l, d, w) + C[1] : r < 48 ? v(l, d, w) + C[2] : r < 64 ? y(l, d, w) + C[3] : g(l, d, w) + C[4],
                    z = (z = B(z |= 0, M[r])) + k | 0,
                    o = k,
                    k = w,
                    w = B(d, 10),
        ...
        var h = o.SHA512 = e.extend({
            ...
            _doProcessBlock: function(t, e) {
                for (var r = this._hash.words, i = r[0], n = r[1], o = r[2], s = r[3], h = r[4], l = r[5], f = r[6], u = r[7], d = i.high, p = i.low, _ = n.high, v = n.low, y = o.high, g = o.low, B = s.high, w = s.low, k = h.high, S = h.low, m = l.high, x = l.low, b = f.high, H = f.low, z = u.high, A = u.low, C = d, D = p, R = _, E = v, M = y, F = g, P = B, W = w, O = k, U = S, I = m, K = x, X = b, L = H, j = z, N = A, T = 0; T < 80; T++) {
                    ...
                    var ft, ut = O & I ^ ~O & X, dt = U & K ^ ~U & L, pt = C & R ^ C & M ^ R & M, _t = D & E ^ D & F ^ E & F, vt = (C >>> 28 | D << 4) ^ (C << 30 | D >>> 2) ^ (C << 25 | D >>> 7), yt = (D >>> 28 | C << 4) ^ (D << 30 | C >>> 2) ^ (D << 25 | C >>> 7), gt = (O >>> 14 | U << 18) ^ (O >>> 18 | U << 14) ^ (O << 23 | U >>> 9), Bt = (U >>> 14 | O << 18) ^ (U >>> 18 | O << 14) ^ (U << 23 | O >>> 9), wt = a[T], kt = wt.high, St = wt.low, mt = j + gt + ((ft = N + Bt) >>> 0 < N >>> 0 ? 1 : 0), xt = yt + _t;
                    j = X,
                    N = L,
                    X = I,
                    L = K,
                    I = O,
                    K = U,
                    O = P + (mt = (mt = (mt = mt + ut + ((ft = ft + dt) >>> 0 < dt >>> 0 ? 1 : 0)) + kt + ((ft = ft + St) >>> 0 < St >>> 0 ? 1 : 0)) + q + ((ft = ft + G) >>> 0 < G >>> 0 ? 1 : 0)) + ((U = W + ft | 0) >>> 0 < W >>> 0 ? 1 : 0) | 0,
                    P = M,
                    W = F,
                    M = R,
                    F = E,
    ...
    l.pad.Iso97971 = {
        pad: function(t, e) {
            t.concat(l.lib.WordArray.create([2147483648], 1)),
            l.pad.ZeroPadding.pad(t, e)
        },
        unpad: function(t) {
            l.pad.ZeroPadding.unpad(t),
            t.sigBytes--
        }
    },
    l.mode.OFB = (c = l.lib.BlockCipherMode.extend(),
    h = c.Encryptor = c.extend({
        processBlock: function(t, e) {
            var r = this._cipher
              , i = r.blockSize
              , n = this._iv
        ...
        var p = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
          , _ = r.AES = e.extend({
            ...
            decryptBlock: function(t, e) {
                ...
                t[e + 1] = t[e + 3],
                t[e + 3] = r,
                this._doCryptBlock(t, e, this._invKeySchedule, h, f, u, d, n);
                r = t[e + 1];
                t[e + 1] = t[e + 3],
                t[e + 3] = r
            },
        ...
        var t = l
          ...
          , f = n.DES = i.extend({
            ...
            _doCryptBlock: function(t, e, r) {
                ...
                for (var i = 0; i < 16; i++) {
                    for (var n = r[i], o = this._lBlock, s = this._rBlock, a = 0, l = 0; l < 8; l++)
                        a |= c[l][((s ^ n[l]) & h[l]) >>> 0];
                    this._lBlock = s,
                    this._rBlock = o ^ a
                }
...
;var a = typeof console !== 'undefined';
var b = -0x64;
window['getComputedFpr'] = function() {
    var f = new Date();
    Fingerprint2['get'](function(g) {
        var h = Fingerprint2['x64hash128'](g['map'](function(n) {
            return n['value'];
        })['join'](), 0x1f);
        var i = new Date();
        var j = i - f;
        var k = {
            'stringify': function(n) {
                var o = {
                    'ct': n['ciphertext']['toString'](CryptoJS['enc']['Base64'])
                };
                if (n['iv'])
                    o['iv'] = n['iv']['toString']();
                if (n['salt'])
            ...
            'parse': function(n) {
                ...
                if (o['iv'])
                    p['iv'] = CryptoJS['enc']['Hex']['parse'](o['iv']);
                if (o['s'])
                    p['salt'] = CryptoJS['enc']['Hex']['parse'](o['s']);
                return p;
            }
        };
        var l = {};
        var m = g;
        window['getComputedStylee'] = function() {
            var n = {
                'testtoken': h,
                'time': j,
                'btrack': b
            };
            var o = CryptoJS['AES']['encrypt'](JSON['stringify'](n), 'kjfldsk32324hvfdsokhlqsdfq3012152ad4k381423l342', {
                'format': k
            })['toString']();
            return h + '-' + o;
        }
...
if (window['requestIdleCallback']) {
    c = requestIdleCallback(window['getComputedFpr']);
    d = cancelIdleCallback;
} else {
    c = setTimeout(window['getComputedFpr'], 0x3e8);
    d = clearTimeout;
}
var e = function() {
    b++;
